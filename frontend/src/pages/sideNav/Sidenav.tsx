...
import BudgetTrackerlogo from "../../assets/BudgetTracker.svg";

const drawerWidth = 320;

const drawerOptions = [
  { id: 0, name: "Expenses", icon: <img src={expensesIcon} alt="expenses" /> },
  { id: 1, name: "Logout", icon: <img src={Logout} alt="logout" /> },
];
